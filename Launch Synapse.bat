...
call :fail "Synapse could not find Python 3.11 or 3.12." ^
    ...
    "Or download Synapse.exe — see docs\windows_install.md"
...
if not exist "synapse_launcher.py" (
    call :fail "synapse_launcher.py not found." ^
        "Make sure the desktop shortcut points at the Synapse project folder," ^
        "not a random subfolder."
)
